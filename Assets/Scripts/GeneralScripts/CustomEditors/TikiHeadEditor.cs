using EnemyScripts.TikiHeadScripts;
...
namespace GeneralScripts.CustomEditors
{
    public class TikiHeadEditor : Editor
    {
        ...
        private SerializedProperty tikiHeadMaxHealth;
        #endregion

        #region Tiki Head Movement Variables
        // ReSharper disable once NotAccessedField.Local
        private SerializedProperty tikiHeadLaunchDelay;
        // ReSharper disable once NotAccessedField.Local
        private SerializedProperty tikiHeadLaunchSpeed;
        // ReSharper disable once NotAccessedField.Local
        private SerializedProperty tikiHeadLaunchDistanceMultiplier;
        private SerializedProperty tikiHeadMoveToGroundDelay;
        ...
        {
            tikiHeadMaxHealth = tikiHeadHealthObject.FindProperty("maxHealth");
        }

        private void SetupTikiHeadMovementEditor()
        {
            tikiHeadLaunchDelay = tikiHeadObject.FindProperty("launchDelay");
            _TikiHeadSightLayers = tikiHeadObject.FindProperty("sightLayers");
            tikiHeadMoveToGroundDelay = tikiHeadObject.FindProperty("moveToGroundDelay");
            ...
            tikiHeadLaunchSpeed = tikiHeadObject.FindProperty("launchSpeed");
            _TikiHeadKnockBackMultiplier = tikiHeadObject.FindProperty("knockBackMultiplier");
            tikiHeadLaunchDistanceMultiplier = tikiHeadObject.FindProperty("launchDistanceMultiplier");
