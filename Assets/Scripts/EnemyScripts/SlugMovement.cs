...
namespace EnemyScripts
{
    public class SlugMovement : EnemyBase
    {
        ...
        private void Start()
        {
            ...
            currentRotation = GeneralFunctions.GetObjectEulerAngle(gameObject);
            
            if (drawDebug)
            {
                print("Starting Rotation: " + currentRotation);
            }
        ...
        private void Update()
        {
            ...
            canMove = ignoreIsGrounded || isGrounded;
            ...
            if (canMove)
            {
                MyMovementComp.MoveAIForward(GeneralFunctions.GetFacingDirectionX(gameObject), moveSpeed, 0f);
            }
        ...
        private void NudgeSlugDown(float xOffset, float yOffset)
        {
            ...
            position = new Vector3(position.x - xOffset, position.y - yOffset, 0);
        ...
        private bool IsGrounded()
        {
            ...
            Vector2 traceEnd = -GeneralFunctions.GetFacingDirectionY(gameObject);
        ...
        private RaycastHit2D LookForCollision()
        {
            ...
            Vector2 traceEnd = GeneralFunctions.GetFacingDirectionX(gameObject);
